...
namespace LiveTalk.API
{
    ...
    public class LiveTalkAPI : IDisposable
    {
        ...
        {
            return CreateCharacterAsync(name, gender, image, pitch, speed, intro, onComplete, onError, false);
        }
        ...
        /// <param name="onComplete">Callback when character is successfully created</param>
        /// <param name="onError">Callback when an error occurs</param>
        /// <param name="useSingleExpression">Whether to use a single expression</param>
            ...
            bool useBundle = true)
        {
            ...
            yield return character.CreateAvatarAsync(useBundle, useSingleExpression);
