...
CLIPS = {
    ...
    "sad": dict(
        ...
        gestures={
            ...
            "browL":   [(0.5, 0), (1.7, -0.6), (4.4, -0.6), (5.6, 0)],
            "browR":   [(0.5, 0), (1.7, -0.55), (4.4, -0.55), (5.6, 0)],
            "smile":   [(0.6, 0), (1.8, -0.95), (4.4, -0.95), (5.6, 0)],
            "lowerOut": [(0.6, 0), (1.8, 0.42), (4.4, 0.42), (5.6, 0)],
            "press":   [(0.6, 0), (1.8, 0.2), (4.4, 0.2), (5.6, 0)],
